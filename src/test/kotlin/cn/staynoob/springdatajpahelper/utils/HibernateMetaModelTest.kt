...
@DataJpaTest
class HibernateMetaModelTest: TestBase() {
    ...
    fun setUp() {
        ...
        metaModel = HibernateMetaModel(columnSample, entityManager.unwrap(Session::class.java))
    }

    @Test
    @DisplayName("ExtractPropertyValue　提取属性值")
    ...
    @Test
    @DisplayName("extractPropertyValue 无法提取的属性值抛出异常")
